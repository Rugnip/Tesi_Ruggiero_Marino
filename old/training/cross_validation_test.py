...
reviews_data = []
with open("/home/marino/tesi/dataset_clean/users_20_pulito.jsonl", "r", encoding="utf-8") as f:
    for line in f:
...
OUTPUT_PATH = "/home/marino/tesi/dataset_training/cross_validation_test.json"
